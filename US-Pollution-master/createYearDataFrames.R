...
for(i in 1:length(cities.uniqueIn2000)){
  ...
  cF.new <- data.frame(NO2Mean.2000, NO2AQI.2000, O3Mean.2000, O3AQI.2000, SO2Mean.2000, SO2AQI.2000, COMean.2000, COAQI.2000, Lat.2000, Long.2000)
...
for(i in 1:length(cities.uniqueIn2001)){
  ...
  cF.new <- data.frame(NO2Mean.2001, NO2AQI.2001, O3Mean.2001, O3AQI.2001, SO2Mean.2001, SO2AQI.2001, COMean.2001, COAQI.2001, Lat.2001, Long.2001)
...
for(i in 1:length(cities.uniqueIn2002)){
  ...
  cF.new <- data.frame(NO2Mean.2002, NO2AQI.2002, O3Mean.2002, O3AQI.2002, SO2Mean.2002, SO2AQI.2002, COMean.2002, COAQI.2002, Lat.2002, Long.2002)
...
for(i in 1:length(cities.uniqueIn2003)){
  ...
  cF.new <- data.frame(NO2Mean.2003, NO2AQI.2003, O3Mean.2003, O3AQI.2003, SO2Mean.2003, SO2AQI.2003, COMean.2003, COAQI.2003, Lat.2003, Long.2003)
...
for(i in 1:length(cities.uniqueIn2004)){
  ...
  cF.new <- data.frame(NO2Mean.2004, NO2AQI.2004, O3Mean.2004, O3AQI.2004, SO2Mean.2004, SO2AQI.2004, COMean.2004, COAQI.2004, Lat.2004, Long.2004)
...
for(i in 1:length(cities.uniqueIn2005)){
  ...
  cF.new <- data.frame(NO2Mean.2005, NO2AQI.2005, O3Mean.2005, O3AQI.2005, SO2Mean.2005, SO2AQI.2005, COMean.2005, COAQI.2005, Lat.2005, Long.2005)
...
for(i in 1:length(cities.uniqueIn2006)){
  ...
  cF.new <- data.frame(NO2Mean.2006, NO2AQI.2006, O3Mean.2006, O3AQI.2006, SO2Mean.2006, SO2AQI.2006, COMean.2006, COAQI.2006, Lat.2006, Long.2006)
...
for(i in 1:length(cities.uniqueIn2007)){
  ...
  cF.new <- data.frame(NO2Mean.2007, NO2AQI.2007, O3Mean.2007, O3AQI.2007, SO2Mean.2007, SO2AQI.2007, COMean.2007, COAQI.2007, Lat.2007, Long.2007)
...
for(i in 1:length(cities.uniqueIn2008)){
  ...
  cF.new <- data.frame(NO2Mean.2008, NO2AQI.2008, O3Mean.2008, O3AQI.2008, SO2Mean.2008, SO2AQI.2008, COMean.2008, COAQI.2008, Lat.2008, Long.2008)
...
for(i in 1:length(cities.uniqueIn2009)){
  ...
  cF.new <- data.frame(NO2Mean.2009, NO2AQI.2009, O3Mean.2009, O3AQI.2009, SO2Mean.2009, SO2AQI.2009, COMean.2009, COAQI.2009, Lat.2009, Long.2009)
...
for(i in 1:length(cities.uniqueIn2010)){
  ...
  cF.new <- data.frame(NO2Mean.2010, NO2AQI.2010, O3Mean.2010, O3AQI.2010, SO2Mean.2010, SO2AQI.2010, COMean.2010, COAQI.2010, Lat.2010, Long.2010)
